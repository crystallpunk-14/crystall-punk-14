...
cp14-job-desc-guildmaster = Организовывайте добычу ресурсов авантюристами, и планируйте их деятельность, чтобы обеспечить их максимальную пользу для поселения.

cp14-job-name-guildworker = Работник гильдии
cp14-job-desc-guildworker = Помогайте гильдмастеру, оберегайте жизни авантюристов и контролируйте чтобы они выполняли свою работу.
