...
cp14-magic-spell-not-enough-mana-cast-warning-item-0 = {$item} дрожит в ваших руках...
cp14-magic-spell-not-enough-mana-cast-warning-item-1 = {$item} начинает неприятно нагреваться...
cp14-magic-spell-not-enough-mana-cast-warning-item-2 = {$item} начинает издавать странный треск...
