...
cp14-skill-menu-free = [color=green]Этот навык врождённый для вашего персонажа, и не тратит очков навыков![/color]
...
cp14-skill-desc-unlock-constructions = Открывает возможность создания структур:

cp14-skill-popup-memory-added = Границы вашего сознания расширяются. Новых очков памяти: {$count}
cp14-skill-popup-memory-losed = Вы начинаете забывать своё прошлое... Потеряно очков памяти: {$count}
