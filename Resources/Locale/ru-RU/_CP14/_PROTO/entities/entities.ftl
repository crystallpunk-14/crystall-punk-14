...
ent-CP14ClothingBackBackpackT2 = вместительный рюкзак
    .desc = Увеличенный рюкзак с большей вместимостью. Идеален для длительных походов. Ограничивает движение, но защищает спину от ударов и сохраняет тепло!

ent-CP14ClothingBackBackpackT3 = дорожный рюкзак
    .desc = Большой, хорошо организованный рюкзак для длительных путешествий с несколькими отделениями. Защищает спину и шею от ударов! Но, к сожалению, в нем неудобно бегать.

ent-CP14ClothingBackBackpackReinforced = укрепленный рюкзак
    .desc = Прочный рюкзак с усиленной строчкой и материалами для дополнительной защиты ваших вещей. Ограничивает движение, но защищает спину от ударов и сохраняет тепло!
...
ent-CP14ClothingBackSatchelT3 = вещмешок
    .desc = Прочный вещмешок с большой вместимостью, предназначенный для длительного использования в полевых условиях. Мешает бегу.
