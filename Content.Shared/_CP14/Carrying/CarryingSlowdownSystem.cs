...
namespace Content.Shared._CP14.Carrying;
...
public sealed class CarryingSlowdownSystem : EntitySystem
{
    ...
    public void SetModifier(EntityUid uid, float walkSpeedModifier, float sprintSpeedModifier,
    ...
    private void OnRefreshMoveSpeed(EntityUid uid, CarryingSlowdownComponent component,
