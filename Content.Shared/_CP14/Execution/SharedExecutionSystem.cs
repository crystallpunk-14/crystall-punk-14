...
public sealed class SharedExecutionSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CP14ExecutionComponent, GetVerbsEvent<UtilityVerb>>(OnGetInteractionsVerbs);
        SubscribeLocalEvent<CP14ExecutionComponent, GetMeleeDamageEvent>(OnGetMeleeDamage);
        SubscribeLocalEvent<CP14ExecutionComponent, SuicideByEnvironmentEvent>(OnSuicideByEnvironment);
        SubscribeLocalEvent<CP14ExecutionComponent, ExecutionDoAfterEvent>(OnExecutionDoAfter);
    }

    private void OnGetInteractionsVerbs(EntityUid uid, CP14ExecutionComponent comp, GetVerbsEvent<UtilityVerb> args)
    {
    ...
    private void TryStartExecutionDoAfter(EntityUid weapon, EntityUid victim, EntityUid attacker, CP14ExecutionComponent comp)
    {
        if (!CanBeExecuted(victim, attacker))
            return;
    ...
    private void OnGetMeleeDamage(Entity<CP14ExecutionComponent> entity, ref GetMeleeDamageEvent args)
    {
    ...
    private void OnSuicideByEnvironment(Entity<CP14ExecutionComponent> entity, ref SuicideByEnvironmentEvent args)
    {
    ...
    private void OnExecutionDoAfter(Entity<CP14ExecutionComponent> entity, ref ExecutionDoAfterEvent args)
    {
